...
from render import (_base, _icon, _task_icon, format_date_de, interval_label,
...
from task_forms import task_form
...
async def _task_form(request: Request, title: str, action: str,
    ...
    return await task_form(
        request, title, action, submit_label, task=task, person=person,
        return_to=return_to, get_areas_fn=get_areas, get_persons_fn=get_persons,
    )
