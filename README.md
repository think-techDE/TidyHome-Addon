...
![Version](https://img.shields.io/badge/version-1.3.64-b5738a)
...
- Optionales Vorher-Foto direkt beim Erstellen neuer Aufgaben
...
- Schlüsselbasierte UI-Übersetzung ohne Veränderung freier Aufgaben-, Raum- oder Projektnamen
...
- Notizen direkt beim Erstellen oder Bearbeiten an Aufgaben hinterlegen, einklappbar wie Fotos
- Vorher-Foto direkt beim Erstellen per Kamera oder Datei vormerken
...
- Zentrale Zugriffslogik hält Dashboard, Aufgaben, Projekte und Haushaltshilfen konsistent
...
tidyhome/
  app/
    ...
    access.py        # Rollen-, Sichtbarkeits- und Zugriffsregeln
    render.py        # HTML-Layout, Navigation und Render-Helfer
    reminders.py     # Manuelle Erinnerungen
    task_actions.py  # Aufgabenaktionen ohne eigenes UI
    task_forms.py    # Aufgabenformular-Renderer
    ...
    storage_app.py     # Admins, Raum-Icons, Urlaubsmodus
    storage_tasks.py   # Aufgaben, Vorlagen, Pausen, Historie, Fotos, Notizen
    storage_projects.py # Projekte, Schritte, Fortschritt und Projekt-Export
    storage_people.py  # Rollen, Personen-Einstellungen, Punkte, Achievements
    storage_housekeeping.py # Haushaltshilfe-Zeiten, Lohnhistorie, Abrechnung
    settings_ui.py     # Personen-Einstellungen als UI-Karten
    settings_exports.py # CSV-/JSON-Export-Responses
    settings_admin_ui.py # Admin-Seitenaufbau
