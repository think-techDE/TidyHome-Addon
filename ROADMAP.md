...
Stand: 2026-05-10 · Aktuelle Version: 1.3.55
...
- `housekeeping_format.py` und `housekeeping_exports.py` enthalten Formatierung und Abrechnungsexporte für Haushaltshilfen
